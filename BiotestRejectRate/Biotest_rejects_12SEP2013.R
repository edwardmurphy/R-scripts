...
#data as csv
data <- read.csv("RR_12SEP2013.csv",header=T,sep=",")
...
rownames(ftol) <- c("All Data (12SEP2013)","Remove lots 130136, 130036",
	"Remove lots 130136, 130036, 130040") -> rownames(otol)

colnames(ftol) <- c("90% Coverage","95% Coverage","99% Coverage") -> colnames(otol)

write.csv(ftol,"fmtol12SEP2013.csv")
write.csv(otol,"otol12SEP2013.csv")
